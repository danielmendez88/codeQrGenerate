...
@section('content')
    ...
    <div class="content mt-3">
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-lg-6">
                    <form action="{{ route('update.personal', ['id' => \Crypt::encrypt($personalDetails->id) ]) }}" method="POST">
                    @csrf
                    @method('POST')
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="organoid" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="adscripcionid" class="form-control">
